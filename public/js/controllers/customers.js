angular.module('mean.customers').controller('CustomerController', ['$scope', 'Global', '$location', '$filter', 'dataService', 'modalService',
    function ($scope, Global, $location, $filter, dataService, modalService) {
