angular.module('mean.customers').controller('CustomerEditController', ['$rootScope', '$scope', '$location', '$routeParams', '$timeout', 'config', 'dataService', 'modalService',
    function ($rootScope, $scope, $location, $routeParams, $timeout, config, dataService, modalService) {
        ...
        $scope.customer;
        $scope.states = [];
        $scope.title = (customerID != 'new') ? 'Edit' : 'Add';
        $scope.buttonText = (customerID != 'new') ? 'Update' : 'Add';
        ...
        $scope.deleteCustomer = function () {
            ...
            modalService.showModal({}, modalOptions).then(function (result) {
                if (result === 'ok') {
                    dataService.deleteCustomer($scope.customer._id).then(function () {
