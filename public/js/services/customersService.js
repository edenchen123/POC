...
angular.module('mean').factory('customersService', ['$http', '$q' , function ($http, $q) {
    var serviceBase = '/',
        customers = null,
        customersFactory = {};
    ...
    customersFactory.updateCustomer = function (customer) {
        return $http.put(serviceBase + 'putCustomer/' + customer._id, customer).then(function (status) {
            return status.data;
        });
    };
